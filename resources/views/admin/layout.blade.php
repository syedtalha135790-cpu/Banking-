    ...
    <div class="sidebar d-flex flex-col justify-content-between py-4">
        <div>
            ...
            <ul class="nav flex-column mt-4">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(Route::is('admin.reports')) active @endif" href="{{ route('admin.reports') }}">
                        <i class="bi bi-graph-up-arrow"></i> System Reports
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if(Route::is('admin.search.index')) active @endif" href="{{ route('admin.search.index') }}">
                        <i class="bi bi-search"></i> Live Audit Search
                    </a>
                </li>
                <li class="nav-item">
