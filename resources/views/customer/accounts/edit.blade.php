...
@section('page_title', 'Modify Account Profile')

@section('content')
<div class="row">
    <div class="col-12 col-lg-8 mx-auto">
        <div class="card card-custom p-4">
            <h5 class="fw-bold mb-4">Edit Personal Information</h5>

            <form action="{{ route('customer.accounts.update', $account->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control @error('occupation') is-invalid @enderror" id="occupation" name="occupation" value="{{ old('occupation', $account->occupation) }}" required placeholder="e.g. Engineer">
                        @error('occupation')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
